    ...
    * You will need to have tls.cert and admin.macaroon already downloaded from your LND node.
     ...
     - Type these commands:
        ...
        * a@A:~> python3 PyBlock.py
        ...
        - Then it will ask you for the IP:PORT (REST PORT).
        ...
        - Then it will ask you for the RPC Username.
        ...
        - Then it will ask you for the RPC Password.
