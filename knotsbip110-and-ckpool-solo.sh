#!/bin/bash
#wget https://raw.githubusercontent.com/curly60e/pyblock/refs/heads/master/knotsbip110-and-ckpool-solo.sh
#chmod +x knotsbip110-and-ckpool-solo.sh
#sudo ./knotsbip110-and-ckpool-solo.sh
...
echo -e "  - Bitcoin KNOTS+BIP110: tail -f $DATADIR/debug.log or journalctl -u bitcoind -f \n"
